        ...
        for (i = 0, ii = data.map.layers.length; i < ii; ++i) {
            ...
            if (sourceType === 'gxp_olsource' && layer.type ===
                ...
                if (layer.capability) {
                    ...
                    // Parse coordinates into float 
                    // const stringCoordinates = layer.capability.bbox[data.map.projection].bbox
                    // layerConfig.properties.extent = stringCoordinates.map(c=>parseFloat(c))
                    console.log(layerConfig.properties.extent)
                }
