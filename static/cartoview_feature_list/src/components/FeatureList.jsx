...
class FeatureList extends React.Component {
    ...
    render( ) {
        ...
        return (
            <Paper  style={{overflowY:'scroll',width:'100%'}}>
                 <div style={{width:'100%'}}>
                ...
                {!selectMode &&<div>
                    <SearchInput layerName={this.selectedLayerName} layerNameSpace={this.selectedLayerNameSpace} filters={this.props.filters} /><Divider light />
                </div>
                }
                ...
                {!(featureIsLoading || attachmentFilesIsLoading) && !searchMode &&!selectMode && totalFeatures > 0 && <div style={{ textAlign: "center" }} className="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-offset-3"><UltimatePaginationMaterialUi
